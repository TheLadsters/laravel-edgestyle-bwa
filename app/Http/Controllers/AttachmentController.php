...
class AttachmentController extends Controller
{
    ...
    {
        $attachmentCacheKey = 'all_attachments';

        // Check if the data is already cached
        if (Cache::has($attachmentCacheKey)) {
            return Cache::get($attachmentCacheKey);
        }
        ...
        Cache::put($attachmentCacheKey, $attachments, 60); // Cache for 60 minutes
